...
$id_Get = filter_var($_GET['id'] , FILTER_SANITIZE_STRING);



if(!empty($id_Get)){
 
    $ffr = mysqli_query($con,"SELECT * FROM users WHERE id='$id_Get' ");
    $fri1 = mysqli_fetch_array($ffr);

    if($id_Get != $fri1['id']){
        header("location: index.php");
        exit();
    }else{
        $name_frind = $fri1['name'];
        $gmail_frind = $fri1['gmail'];
        $img_frind = $fri1['img'];
                ...
                <div class="con_alls">
                    <div class="top11">
                        <div class="infoo">
                            <div class="inf1">
                                <div class="inf_left">
                                    <img src="<?php echo $img_frind ?> " alt="">
                                    <p class="name12"> <?php echo $name_frind ?> </p>
                                </div>
...
$Allmsgs = mysqli_query($con,"SELECT * FROM chatfrind ORDER BY id DESC"); ////////////////////////////////////////////////////////////////
...
?>
                    ...
                    <form action="send_msg_frind.php" method="post">
                    ...
                    <div class="bottom11">
                        ...
                        <input name="frind" value='<?php echo $gmail_frind ?>' type="text" style='display: none' >
                        <input name="gmail_me" value='<?php echo $gmail ?>' type="text" style='display: none' >
